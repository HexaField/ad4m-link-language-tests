...
PREWARM_PROTOS=(nostr matrix solid atproto ipfs hypercore nextgraph peer2panda anytype freenet)
...
if wait_executor 15; then
    ...
    for lang_var in LANG_MATRIX LANG_ATPROTO LANG_SOLID LANG_IPFS LANG_NOSTR \
                    LANG_HYPERCORE LANG_NEXTGRAPH LANG_PEER2PANDA LANG_ANYTYPE LANG_FREENET; do
        lang_addr="${!lang_var:-}"
